...
// */
//package com.draksterau.SRegen.integration;
//
//import com.draksterau.SRegen.config.integrationConfigHandler;
...
//            return ("SRegen.regen.factionsone." + getPlayerRelation(player,chunk).name());
//    }
//    
//    @Override
...
//            if (player.hasPermission("SRegen.regen.factionsone." + getPlayerRelation(player,chunk).name())) {
//                return true;
//            } else {
//                return false;
//            }
