...
public final class RConfig extends RObject {
    ...
    // Minimum TPS for SRegen to continue running parses.
    public int minTpsRegen = 15;
    
    // Should SRegen run without grief prevention plugins enabled?
