package com.stargatemc.SRegen;

//import com.draksterau.SRegen.commands.SRegenCommand;
import com.stargatemc.SRegen.listeners.eventListener;
...
import com.stargatemc.SRegen.handlers.RConfig;
import com.stargatemc.SRegen.handlers.RLang;
import com.stargatemc.SRegen.handlers.RUtils;
import com.stargatemc.SRegen.handlers.RWorld;
import com.stargatemc.SRegen.commands.SRegenCommand;

public class SRegen extends JavaPlugin implements Listener {
        ...
        if (this.isEnabled()) {
            ...
            if (loadedIntegrations.isEmpty()) {
                if (config.noGriefRun) {
                    ...
                    utils.throwMessage("info", "SRegen supports the following plugins:");
                    utils.iterateIntegrations();
                    utils.throwMessage("severe", "You must set 'noGriefRun' to true in config before SRegen will load without integrations.");
                }
            }
            if (this.isEnabled()) {
                utils.loadWorlds();
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        SRegenCommand SRegenCommand = new SRegenCommand(this, sender, cmd, label, args);
        return SRegenCommand.doCommand();
    }
